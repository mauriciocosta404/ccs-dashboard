...
export default function CreateSectorModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!name.trim()) {
      toast.error("Por favor, preencha o nome do sector.");
      return;
    }
    ...
    try {
      await httpClient.post("/sector", {
        name: name.trim(),
      });

      toast.success("Sector criado com sucesso!");
      setName("");
      onClose();
      if (onSuccess) {
        onSuccess();
      ...
      const errorMessage =
        ...
        "Erro ao criar sector. Tente novamente.";
      ...
      <div className="no-scrollbar relative w-full overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
        <div className="px-2 pr-14">
          ...
          <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
            Adicione um novo sector ao sistema.
          </p>
        </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                <div className="col-span-2">
                  <Label htmlFor="sector-name">Nome do Sector</Label>
                  <Input
                    id="sector-name"
                    type="text"
